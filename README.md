...
```bash
python3 openxss.py -u "http://example.com/page.php?q=query"
```
...
For frequently asked questions, please visit our [FAQ page](https://github.com/IlumCI/OpenXSS/wiki/FAQ).
